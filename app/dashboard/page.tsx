        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[#111118] border border-[#1E1E2E] rounded-2xl overflow-hidden">
              <div className="p-6 border-b border-[#1E1E2E] flex items-center justify-between">
                ...
                <Link href="/dashboard/campaigns" className="text-sm text-[#6EE7B7] hover:underline">
                  View All
                </Link>
              </div>
              <div className="p-6">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#111118] border border-[#1E1E2E] rounded-2xl p-6 space-y-2">
              ...
              <Link href="/dashboard/campaigns" className="flex items-center gap-3 p-3 bg-[#0A0A0F] text-[#F1F5F9] rounded-xl border border-[#1E1E2E] hover:border-[#6EE7B7]/50 transition-all font-medium">
                <LayoutDashboard className="w-5 h-5 text-[#6EE7B7]" /> Campaign Manager
              </Link>
              <Link href="/dashboard/donors" className="flex items-center gap-3 p-3 text-[#64748B] hover:bg-[#0A0A0F] hover:text-[#F1F5F9] rounded-xl transition-all font-medium">
                <Users className="w-5 h-5" /> Donor Analytics
              </Link>
              <Link href="/dashboard/audit" className="flex items-center gap-3 p-3 text-[#64748B] hover:bg-[#0A0A0F] hover:text-[#F1F5F9] rounded-xl transition-all font-medium">
                <History className="w-5 h-5" /> Audit Trail
              </Link>
              <Link href="/dashboard/subscription" className="flex items-center gap-3 p-3 text-[#64748B] hover:bg-[#0A0A0F] hover:text-[#F1F5F9] rounded-xl transition-all font-medium">
